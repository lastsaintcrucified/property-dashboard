...
export function Card({
	...
	return (
		<motion.div
			...
			className='card rounded-xl bg-gray-50 p-2 '
		>
			<div className='flex p-4'>
				{Icon ? <Icon className='h-8 w-8 text-gray-500 font-bold' /> : null}
				<h3 className='ml-2 text-md font-mono tracking-tighter'>{title}</h3>
			</div>
			<div className='flex justify-end items-center p-3'>
				<span className='leading-none text-4xl font-bold tracking-tighter bg-gradient-to-b from-black to-[#001E80] text-transparent bg-clip-text'>
					{value}
				</span>
			</div>
		</motion.div>
